...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6963524590559131924L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"DataContract.Item\",\"fields\":[{\"name\":\"ID\",\"type\":\"int\"},{\"name\":\"Name\",\"type\":\"string\"},{\"name\":\"TypeID\",\"type\":\"int\"},{\"name\":\"DangerID\",\"type\":\"int\"}]}");
   ...
   */
  public Item(java.lang.Integer ID, java.lang.CharSequence Name, java.lang.Integer TypeID, java.lang.Integer DangerID) {
    this.ID = ID;
    this.Name = Name;
    this.TypeID = TypeID;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: DangerID = (java.lang.Integer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static DataContract.Item.Item.Builder newBuilder() {
    return new DataContract.Item.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static DataContract.Item.Item.Builder newBuilder(DataContract.Item.Item.Builder other) {
    if (other == null) {
      return new DataContract.Item.Item.Builder();
    } else {
      return new DataContract.Item.Item.Builder(other);
    }
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static DataContract.Item.Item.Builder newBuilder(DataContract.Item.Item other) {
    if (other == null) {
      return new DataContract.Item.Item.Builder();
    } else {
      return new DataContract.Item.Item.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(DataContract.Item.Item.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.DangerID)) {
        this.DangerID = data().deepCopy(fields()[3].schema(), other.DangerID);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(DataContract.Item.Item other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ID)) {
        this.ID = data().deepCopy(fields()[0].schema(), other.ID);
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder setID(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder clearID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder clearName() {
      Name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder setTypeID(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder clearTypeID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder setDangerID(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DataContract.Item.Item.Builder clearDangerID() {
    ...
    public Item build() {
      try {
        ...
        record.DangerID = fieldSetFlags()[3] ? this.DangerID : (java.lang.Integer) defaultValue(fields()[3]);
        return record;
